#!/usr/bin/env python3
"""
Clean Demo Terminal: Run this in a separate terminal for recording
No IDE, no code - just clean agent responses
"""
...
try:
    ...
    print("Make sure you're in the agents directory")
    sys.exit(1)

class CleanDemoTerminal:
    def __init__(self):
    ...
    def parse_log_entry(self, log_line: str):
        ...
        try:
            ...
            if 'payment' in message.lower() and 'successfully' in message.lower():
                # Ask user for real amount
                print(f"\n💳 Transaction detected: {message}")
