#!/usr/bin/env python3
"""
Real-Time Database Transaction Monitor: Monitors PostgreSQL ledger-db for new transactions
Agents react to actual user transactions from the database in real-time
"""
...
class RealTimeDatabaseMonitor:
    ...
    def handle_transaction_created(self, event: Dict):
        ...
        print(f"🆔 ID: {event.get('transaction_id', 'N/A')}")
    ...
    def parse_transaction_data(self, db_output: str) -> Optional[Dict]:
